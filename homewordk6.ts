...
export default function hwork(){
    type CurZeroType = (a :string) => string
    let curZero :CurZeroType = (a :string) => {
        return a.replace(/^0+/, "");
    }
    
    //console.log(curZero("00012"));
    ...
    */
    ...
    function globalFunc(a :string, func1 :CurZeroType, func2 :RemoveDashType) :number {
